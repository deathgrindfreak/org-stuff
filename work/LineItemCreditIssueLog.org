...
*** DONE Need to fix the navigation in the "Credit Entire Invoice" page
    CLOSED: [2015-01-29 Thu 17:13]
*** DONE Fix the style issues on the Batch Edit view page.
    CLOSED: [2015-01-29 Thu 17:13]
*** DONE Fix the "Need to enter a row before saving" error for the batch document save.
    CLOSED: [2015-01-29 Thu 17:13]
*** TODO Need to make sure that errors are handled properly when adding credits (for instance, adding a line item credit twice).
*** DONE If the errors are fixed, add a "successful update" notification on the screen.
    CLOSED: [2015-01-29 Thu 17:14]
*** DONE Fix the search by documents feature
    CLOSED: [2015-01-29 Thu 17:14]
...
*** DONE Need to ensure that the parameter hash table is set up properly in BatchDocumentDAOImpl (createOrUpdateBatchDocument line 298)
    CLOSED: [2015-01-29 Thu 17:14]
...
*** DONE CHB (handbill) doesn't want to add new rows to LIC table (and probably the ACD table as well)
    CLOSED: [2015-01-29 Thu 17:14] SCHEDULED: <2015-01-13 Tue>
...
*** DONE Need validation when leaving a newly created batch document
    CLOSED: [2015-01-29 Thu 17:15]
*** DONE Work on the search (seems to not be accurate for batch# search anyway)
    CLOSED: [2015-01-29 Thu 17:15]
...
*** DONE I believe that a document must have at least one LIC before saving.  If so, we'll need to provide some validation.
    CLOSED: [2015-01-29 Thu 17:16]
*** DONE Saving a doc causes the save prompts for the leaving the current doc on tree and hitting the back button to pop up
    CLOSED: [2015-01-29 Thu 17:16]

*** DONE Line Item Credits, ACD and Comment aren't currently saved in the DB upon refeshing the page.  Also, Customer Name is generated on search somehow and not save.
    CLOSED: [2015-01-29 Thu 17:16]
...
*** TODO Need to handle changes to customer id.
